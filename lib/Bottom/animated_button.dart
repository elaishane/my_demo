...
class _AnimatedButtonState extends State<AnimatedButton>
  ...
  void initState() {
    ...
    _smallDuration = Duration(
        milliseconds: (widget.animatedDuration.inMilliseconds * 0.2).round());
    _controller =
    ...
    _controller.addStatusListener((_currentStatus) {
      if (_currentStatus == AnimationStatus.completed) {
        return widget.onTap();
      }
    });
      ...
      child: InkWell(
        ...
        child: AnimatedContainer(
          ...
          padding: EdgeInsets.symmetric(
              horizontal:
                  (_currentState == ButtonState.SHOW_ONLY_ICON) ? 16.0 : 24.0,
              vertical: 8.0),
          child: AnimatedSize(
            vsync: this,
            curve: Curves.easeIn,
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                SizedBox(
                  width:
                      _currentState == ButtonState.SHOW_ONLY_ICON ? 30.0 : 0.0,
                ),
                getTextWidget()
              ],
            ),
  ...
  Widget getTextWidget() {
    if (_currentState == ButtonState.SHOW_ONLY_TEXT) {
      ...
      return ScaleTransition(
          ...
          child:
              Text(widget.finalText, style: widget.buttonStyle.finalTextStyle));
    }
  }
}
